    ...
    <main className="flex flex-col gap-16 mt-16 pb-24">
      <div className="flex flex-col gap-6">
        ...
        <p className="text-base text-white/45 font-light max-w-full leading-relaxed">
          Writing from me, and a handful of pieces from people thinking about
          ...
          <>
            {scribbles.map((scribble) => (
              <Link
                ...
                className="group flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between sm:gap-8 border-t border-white/10 py-6 hover:border-white/30 transition-colors duration-200"
              >
                <div className="flex flex-col gap-2">
                  ...
                  <span className="text-sm text-white/45 font-light leading-relaxed sm:max-w-lg">
                    {scribble.excerpt}
                  </span>
                </div>
                <span className="text-xs text-white/30 font-light sm:shrink-0 sm:pt-1">
                  {scribble.date}
                </span>
              </Link>
            ))}
